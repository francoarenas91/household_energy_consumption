...
To assess the importance of each house feature in energy consumption, we merged the static and dynamic data, selecting a sample of 5% of the rows to run a random forest model. This approach helped us determine the importance of each feature in explaining electricity consumption. The most significant features identified are XXX. For further analysis, we only selected features with an importance higher than 0.95%.
...
panel_model <- plm(total_electricity ~ temperature, 
                data = panel_data, 
                model = "within")
stargazer(panel_model, type = "latex",header = FALSE)
